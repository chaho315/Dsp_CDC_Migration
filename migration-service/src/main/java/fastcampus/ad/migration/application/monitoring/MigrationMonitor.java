...
public class MigrationMonitor {
    ...
    public MigrationMonitorMetrics measure() {
        ...
        PageMigrations adGroupPageMigrations = PageMigrations.of(adGroupPageMigrationRepository.findAll());
        PageMigrations keywordPageMigrations = PageMigrations.of(keywordPageMigrationRepository.findAll());
        return MigrationMonitorMetrics.from(migrationUsers, adGroupPageMigrations, keywordPageMigrations);
    }
}
